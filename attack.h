...
* @pre @p state and @p round_key must be a valid pointer toward an array with a size of Nb * 4 and Nb * (Nr + 1) respectively
**/
...
*@details Generate a delta set, i.e. a set of 256 plaintexts with the same byte in the same position, and the same byte in the other positions
